  ...
  return (
    <section className="KaDoBu-05" style={{ background: '#0B0B2A', color: '#fff', padding: '60px 0' }}>
      <div className="container text-center">
        ...
        <a href="https://kadobu.com/" target="_blank" rel="noopener noreferrer" className="t-btn" style={{ background: '#FF6B00', color: '#fff', padding: '12px 32px', borderRadius: '30px', fontWeight: 600, textDecoration: 'none' }}>Visit Website</a>
      </div>
    </section>
  );
}
