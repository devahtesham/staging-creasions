...
export default function Section2({ data, timeline }) {
    const backgroundImage = data?.background_image || "/clairmont/section-2.webp"
    const sections = data?.sections || {}
    const timelineImage = timeline?.images?.[0] || "/clairmont/sec02-bg.webp"

    return (
        <section
            className="Clairmont-02"
            style={{
                backgroundImage: backgroundImage.startsWith('http') ? `url(${backgroundImage})` : `url(${backgroundImage})`
            }}
        >
