...
export default function Section5({ portfolioData }) {
    ...
    const portfolioImages = portfolioData?.cards?.length > 0 
        ? portfolioData.cards.map(card => card.image)
        : fallbackImages;

    const sectionHeading = portfolioData?.section_heading || "Our Work";
    const buttonText = portfolioData?.button_text || "View All Work";
    const buttonUrl = portfolioData?.button_url || "/portfolio/website-design";
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-12">
                        ...
                        {buttonText && (
                            <div className="text">
                                <Link href={buttonUrl} className="btn t-btn">
                                    {buttonText} <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
